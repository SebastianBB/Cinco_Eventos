    ...
    public partial class frmPuzzleGame : Form
    {
        ...
        public frmPuzzleGame()
        {
            ...
            lstOriginalPictureList.AddRange(new Bitmap[] { Properties.Resources._1, Properties.Resources._2,
                ...
                Properties.Resources._7, Properties.Resources._8, Properties.Resources._9, Properties.Resources._null });
        ...
        void Shuffle()
        {
            ...
            {
                int j;
                List<int> Indexes = new List<int>(new int[] { 0, 1, 2, 3, 4, 5, 6, 7, 9 });//8 no está presente porque es la última imagen
                Random r = new Random();
                for (int i = 0; i < 9; i++)
                {
        ...
        private void btnShuffle_Click(object sender, EventArgs e)
        {
            ...
            {
                YesOrNo = MessageBox.Show("¿Estás seguro que deseas REINICIAR?", "Zelda Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            }
            if (YesOrNo == DialogResult.Yes || lblTimeElapsed.Text == "00:00:00")
            {
                ...
                lblTimeElapsed.Text = "00:00:00";
                inmoves = 0;
                lblMovesMade.Text = "Movimientos Hechos : 0";
            }
        }

        private void AskPermissionBeforeQuite(object sender, FormClosingEventArgs e)
        {
            DialogResult YesOrNO = MessageBox.Show("¿Estás seguro que deseas SALIR?", "Zelda Puzzle", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void SwitchPictureBox(object sender, EventArgs e)
        {
            ...
            if (inNullSliceIndex != inPictureBoxIndex)
            {
                ...
                if (FourBrothers.Contains(inNullSliceIndex))
                {
                    ...
                    lblMovesMade.Text = "Movimientos Hechos : " + (++inmoves);
                    if (CheckWin())
                    {
                        timer.Stop();
                        (gbPuzzleBox.Controls[8] as PictureBox).Image = lstOriginalPictureList[8];
                        MessageBox.Show("Felicitaciones...\nHas completado el Puzzle\nTiempo transcurrido : " + timer.Elapsed.ToString().Remove(8) + "\nTotal de movimientos : " + inmoves, "Zelda Puzzle");
                        inmoves = 0;
                        lblMovesMade.Text = "Movimientos Hechos : 0";
                        lblTimeElapsed.Text = "00:00:00";
                        timer.Reset();
